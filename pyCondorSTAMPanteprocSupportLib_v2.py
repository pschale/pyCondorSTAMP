...
def handle_varying_variables_and_save_anteproc_paramfile(varying_anteproc_variables, anteproc_dict, anteproc_file_name, anteproc_file_names, anteproc_default_data, quit_program, anteproc_job = None, anteprocJobDictTracker = None, injectionStartTimes = None):
        ...
        for variation_index in range(0, num_variations):
            ...
            if injectionStartTimes:
                if "H1-" in temp_anteproc_name:
                    ...
                    print("Warning, unknown IFO used. Please review and fix input or code as needed.")
                    quit_program = True
...
def handle_injections_and_save_anteproc_paramfile(multiple_waveforms, waveform_bank, varying_anteproc_variables, anteproc_dict, anteproc_file_name, anteproc_default_data, on_the_fly_bool, quit_program, anteproc_job = None, anteprocJobDictTracker = None, injectionStartTimes = None):
    ...
    if multiple_waveforms and not on_the_fly_bool:
        ...
        for waveform_key in waveform_bank:
            ...
            if waveform_bank[waveform_key]:
                ...
                #save_anteproc_paramfile(anteproc_dict, temp_anteproc_name, anteproc_default_data)
                #anteproc_file_names += [temp_anteproc_name]
                anteproc_file_names, quit_program = handle_varying_variables_and_save_anteproc_paramfile(varying_anteproc_variables, anteproc_dict, anteproc_file_name, anteproc_file_names, anteproc_default_data, quit_program)
            else:
        ...
        #save_anteproc_paramfile(anteproc_dict, anteproc_file_name, anteproc_default_data)
        #anteproc_file_names += [anteproc_file_name]
        anteproc_file_names, quit_program = handle_varying_variables_and_save_anteproc_paramfile(varying_anteproc_variables, anteproc_dict, anteproc_file_name, anteproc_file_names, anteproc_default_data, quit_program, anteproc_job, anteprocJobDictTracker, injectionStartTimes)
...
def anteproc_job_specific_setup(job_list, ifo, anteproc_directory, job_dictionary, anteproc_dict, used_seed_tracker, organized_seeds, multiple_waveforms, waveform_bank, anteproc_default_data, anteproc_jobs, varying_anteproc_variables, quit_program, anteprocJobDictTracker = None, injectionStartTimes = None):
    ...
    for temp_job in job_list:
            ...
            anteproc_jobs[ifo][temp_job], quit_program = handle_injections_and_save_anteproc_paramfile(multiple_waveforms, waveform_bank, varying_anteproc_variables, anteproc_dict,
                                                anteproc_H_name_temp, anteproc_default_data, on_the_fly_bool, quit_program, temp_job, anteprocJobDictTracker, injectionStartTimes)
