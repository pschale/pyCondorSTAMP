...
def handle_varying_variables_and_save_anteproc_paramfile(varying_anteproc_variables, anteproc_dict, anteproc_file_name, anteproc_file_names, anteproc_default_data, quit_program):
    ...
    if "num_jobs_to_vary" in varying_anteproc_variables:
        ...
        for variation_index in range(0, num_variations):
            ...
            file_name_modifer = "_v" + str(temp_number)
...
def handle_injections_and_save_anteproc_paramfile(multiple_waveforms, waveform_bank, varying_anteproc_variables, anteproc_dict, anteproc_file_name, anteproc_default_data, on_the_fly_bool, quit_program):
...
def anteproc_job_specific_setup(job_list, ifo, anteproc_directory, job_dictionary, anteproc_dict, used_seed_tracker, organized_seeds, multiple_waveforms, waveform_bank, anteproc_default_data, anteproc_jobs, varying_anteproc_variables, quit_program):
    ...
    for temp_job in job_list:
            ...
            anteproc_jobs[ifo][temp_job], quit_program = handle_injections_and_save_anteproc_paramfile(multiple_waveforms, waveform_bank, varying_anteproc_variables, anteproc_dict,
                                                anteproc_H_name_temp, anteproc_default_data, on_the_fly_bool, quit_program)
