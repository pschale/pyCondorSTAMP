...
if options.dots:
    plt.plot(sortedAllSNRs, all_percentage,'b.-', label = "Background")
    plt.plot(meanSimulatedSNR, all_percentage,'k.--', label = "Simulation mean")
    plt.plot(sortedAllSimulatedSNRs[0], allSimulated_percentage[0],'g.-', label = "Gaussian Simulations", alpha = 0.3)
    ...
    #plt.plot(sortedAllSimulatedSNRs, allSimulated_percentage,'g.--', label = "Gaussian Simulations")
...
plt.grid(b=True, which='major',color='0.75',linestyle='-')
if options.dots:
    plt.plot(sortedAllSNRs, all_percentage,'b.-', label = "Background", linewidth = 2)
    plt.plot(meanSimulatedSNR, all_percentage,'k.--', label = "Simulation mean")
    plt.plot(sortedAllSimulatedSNRs[0], allSimulated_percentage[0],'g.-', label = "Gaussian Simulations", alpha = 0.3)
    if len(sortedAllSimulatedSNRs) > 1:
        for num in range(1,len(sortedAllSimulatedSNRs)):
    ...
    plt.plot(sortedAllSNRs, all_percentage,'b-', label = "Background", linewidth = 1.5, zorder = 4)
    plt.plot(meanSimulatedSNR, all_percentage,'k--', label = "Simulation mean", zorder = 5)
    ...
    plt.plot(sortedAllSimulatedSNRs[0], allSimulated_percentage[0],'g-', label = "Gaussian Simulations", alpha = 0.3, zorder = 3)
    if len(sortedAllSimulatedSNRs) > 1:
        for num in range(1,len(sortedAllSimulatedSNRs)):
...
if options.dots:
    plt.plot(sortedAllSNRs, all_percentage,'b.-', label = "Background", linewidth = 2)
    plt.plot(meanSimulatedSNR, all_percentage,'k.--', label = "Simulation mean")
    #simDist, = plt.plot(sortedAllSimulatedSNRs[0], allSimulated_percentage[0],'g.-', label = "Gaussian Simulations", alpha = 0.3)
    #if len(sortedAllSimulatedSNRs) > 1:
    #    for num in range(1,len(sortedAllSimulatedSNRs)):
    #        plt.plot(sortedAllSimulatedSNRs[num], allSimulated_percentage[num],'g.-', alpha = 0.3)
    #plt.plot(sortedAllSimulatedSNRs, allSimulated_percentage,'g.--', label = "Gaussian Simulations")
    ...
    plt.fill_betweenx(all_percentage, sigmaTwoSimSNRHigh, sigmaThreeSimSNRHigh, color='grey', alpha='0.3', zorder = 3)
    #plt.fill(sigmaOneSimSNRLow + sigmaOneSimSNRHigh, all_percentage+all_percentage, edgecolor = None, color=0.5, alpha='0.5')
    #simDist, = plt.plot(sortedAllSimulatedSNRs[0], allSimulated_percentage[0],'g-', label = "Gaussian Simulations", alpha = 0.5)
    #if len(sortedAllSimulatedSNRs) > 1:
    #    for num in range(1,len(sortedAllSimulatedSNRs)):
...
if options.dots:
    ...
    plt.plot(sortedAllSNRs, all_percentage,'b-', label = "Background", linewidth = 1.5, zorder = 5)
    ...
    plt.fill_betweenx(all_percentage, sigmaTwoSimSNRLow, sigmaThreeSimSNRLow, color='grey', alpha='0.3', zorder = 3)
    plt.fill_betweenx(all_percentage, sigmaTwoSimSNRHigh, sigmaThreeSimSNRHigh, color='grey', alpha='0.3', zorder = 3)
    plt.plot(sortedAllSimulatedSNRs[0], allSimulated_percentage[0],'r-', label = "Gaussian Simulations", alpha = 0.5, zorder = 4)
    if len(sortedAllSimulatedSNRs) > 1:
        for num in range(1,len(sortedAllSimulatedSNRs)):
